...
create table if not exists public.readiness_summaries (
  ...
  teacher_id uuid not null references public.profiles (id) on delete cascade,
  group_id uuid not null references public.groups (id) on delete cascade,
  content text not null default '',  -- бүлгийн жилийн эцсийн дүгнэлт (AI эсвэл багшийн бичсэн)
  updated_at timestamptz not null default now(),
  unique (group_id)
);
...
create table if not exists public.garaa_summaries (
  ...
  teacher_id uuid not null references public.profiles (id) on delete cascade,
  group_id uuid not null references public.groups (id) on delete cascade,
  content text not null default '',  -- бүлгийн гарааны үнэлгээний нэгдсэн дүгнэлт (AI эсвэл багшийн бичсэн)
  updated_at timestamptz not null default now(),
  unique (group_id)
);
...
create table if not exists public.outcome_summaries (
  ...
  teacher_id uuid not null references public.profiles (id) on delete cascade,
  group_id uuid not null references public.groups (id) on delete cascade,
  content text not null default '',  -- бүлгийн СҮД дүгнэлтийн нэгдсэн тайлан (AI эсвэл багшийн бичсэн)
  updated_at timestamptz not null default now(),
  unique (group_id)
);
...
create table if not exists public.fitness_summaries (
  ...
  teacher_id uuid not null references public.profiles (id) on delete cascade,
  group_id uuid not null references public.groups (id) on delete cascade,
  content text not null default '',  -- бүлгийн биеийн тамирын сорилын нэгдсэн дүгнэлт (AI эсвэл багшийн бичсэн)
  updated_at timestamptz not null default now(),
  unique (group_id)
);
...
create table if not exists public.fitness_overall_summaries (
  id uuid primary key default gen_random_uuid(),
  teacher_id uuid not null references public.profiles (id) on delete cascade,
  content text not null default '',  -- бүх бүлгийг хамарсан нэгдсэн (цэцэрлэгийн түвшний) дүгнэлт
  updated_at timestamptz not null default now(),
  unique (teacher_id)
);
